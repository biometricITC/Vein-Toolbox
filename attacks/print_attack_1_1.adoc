...
The following assumes the camera is used for the NIR light scanner, as no commercial scanners are available for the attack and developing an in-house scanner exceeds the Basic attack potential at the time of development of this version.

[cols=".^2,.^2,^.^1,.^2,^.^1,^.^1",options="header",]
.Attack Potential Print attack 1
|===
|Factor 
...
6+^.^|Total Attack Potential = 12 < Enhanced Basic Attack Potential
