...
+
The evaluator shall create composite image artefacts that put the printed artefact for visible light vein image (Artefact for *print attack (visible light image)*) on another printed artefact for NIR light vein image (Artefact for *print attack (NIR light image)*).
+
