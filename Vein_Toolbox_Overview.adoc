...
. Artefact creation  
  a. Artefact for *print attack (NIR light image)*
+
...
+
  b. Artefact for *print attack (Visible light image)*
+
...
+
  c. Artefact for *print attack (Combined image)*
+
...
+
  d. Artefact for *video attack (Visible light image)*
+
